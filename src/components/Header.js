	...
	return (
		<header className="header">
			<div className="wrapper">
				<div className="header-logo"><Link to="/"><img src="img/logo-2.svg" alt=""/></Link></div>
				<div className="header-row">
					...
					<Link to="/order" className="primary-btn">Get Now</Link>
				</div>
				<div className="header-bar"><span/></div>
			</div>
		</header>
	)
}