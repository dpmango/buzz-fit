  ...
  rows: [
    {
      ...
      content: (
        <>
          <p>
            When you order from Buzz Fit, you’ll choose a dispatch method when you check out. Your choice will affect
            how long it takes for your order to be delivered.
          </p>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            If you have ordered more than one device, your order may be sent in more than one shipment to ensure you get
            your items as stock is available.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li>
              The delivery price at checkout is for your whole order. Shipments costs for each shipment are charged when
              your orders are dispatched.
            </li>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            All purchases made between 8 December 2019 and 25 December 2019 have an extended return date of 21 January
            2020. Purchases made after 25 December 2019 are subject to the Standard Return Policy for all states.
          </p>
        </>
      ),
    },
