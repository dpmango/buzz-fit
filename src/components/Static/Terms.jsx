  ...
  const content = useMemo(() => {
    return {
      ...
      rows: [
        {
          id: 1,
          title: 'Welcome to Buzz Fit',
          content: (
            <>
              <p>These terms and conditions outline the rules and regulations for the use of the Buzz Fit website.</p>
              <p>
                Buzz Fit is located at Strathvale House, 90 North Church Street, George Town P.O. Box 10315, KY1-1003,
                Grand Cayman, Cayman Islands.
              </p>
              <p>
                By accessing this website we assume you accept these terms and conditions in full. Do not continue to
                use Buzz Fit’s website, if you do not accept all of the terms and conditions.
              </p>
              <p>
                ...
                to, prevailing law of the Cayman Islands. Any use of the above terminology or other words in the
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                We employ the use of cookies. By using Buzz Fit’s website you consent to the use of cookies following
                Buzz Fit’s privacy policy. Most of the modern-day, interactive websites use cookies to enable us to
                retrieve user details on each visit. Cookies are used in some areas of our site, to enable the
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                Unless otherwise stated, Buzz Fit and/or its licensors own the intellectual property rights for all
                material on Buzz Fit. All intellectual property rights are reserved. You may view and/or print pages
                from Buzz Fit for your own personal use subject to restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>

              <ul>
                <li>Republish material from Buzz Fit</li>
                <li>Sell, rent or sub-license material from Buzz Fit</li>
                <li>Reproduce, duplicate or copy material from Buzz Fit</li>
                <li>Redistribute content from Buzz Fit (unless content is specifically made for redistribution).</li>
              </ul>
              ...
              <p>
                ...
                manner as they hyperlink to the Web sites of other listed businesses; and Systemwide Accredited
                Businesses except soliciting non-profit organizations, charity shopping malls, and charity fundraising
              ...
              <p>
                ...
                Automobile Association, AARP and Consumers Union; dot.com community sites; associations or other groups
                representing charities, including charity giving sites, online directory distributors; internet portals;
                accounting, law and consulting firms whose primary clients are businesses; and educational institutions
              ...
              <p>
                ...
                website, you must notify us by sending an e-mail to info@buzz.fit
              </p>
              <p>
                ...
                Website, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a
                response.
              </p>
              ...
              <ul>
                ...
                <li>
                  No use of Buzz Fit’s logo or other artwork will be allowed for linking absent a trademark license
                  agreement.
                </li>
              </ul>
            </>
          ...
          content: (
            <>
              ...
              <p>
                ...
                conditions. Removal of links from our website If you find any link on our Website or any linked website
                objectionable for any reason, you may contact us about this. We will consider requests to remove links
                but will have no obligation to do so or to respond directly to you.
              </p>
              <p>
