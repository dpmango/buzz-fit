      ...
      <div className="homepage">
        <section className="main">
          <div className="wrapper">
            <div className="main-info">
              ...
              <p>
                Cut your cable bill & employ our specialty specific health programing to engage your patients as they
            ...
            <div className="wrapper">
              ...
              <div className="info-row">
                <div className="info-col">
                  ...
                  <p>
                    The risk of not engaging patients in the waiting area can be detrimental to the success of a
                    practice.
                  </p>
          ...
          <div className="info-block info-2">
            <div className="wrapper">
              ...
              <div className="info-row">
                <div className="info-col">
                  <p>
                    Imagine—a service that results in fewer frustrations, more focus in consultation, and better
                    outcomes with your patients while generating passive income for you.
                  </p>
                </div>
                <div className="info-col">
                  <p>
                    Buzz Fit streaming service reliably delivers relevant and impactful video to your waiting patients
                    in the highest quality with access video experience insights
                  </p>
                </div>
              </div>
            ...
            <div className="wrapper">
              <div className="info-row">
                <div className="info-col">
                  ...
                  <div className="info-text">
                    <p>
                      Your biggest loss of revenue is patient churn, costing you 30% of your patient roster annually.
                    </p>
                    <p>
              ...
              <Slider {...sliderSettingsThree}>
                ...
                <div className="steps-col">
                  <div className="steps-wrap">
                    ...
                    <p>
                      You will be up and running in 2 minutes, track your revenue and progress in the physician app.
                    </p>
                    <Link to="/order" className="primary-btn">
                      Get your TV Box Now
                    </Link>
          ...
          <div className="wrapper">
            <div className="begin-row">
              ...
              <div className="begin-info">
                ...
                <p>
                  It’s easy to get frustrated and overwhelmed and to feel guilty for not having time for your patients.
                  With an ever-increasing workload, trying to juggle the responsibilities of running a business & caring
                  for patients is difficult.
                </p>
                <span className="begin-subtitle">
                  Don't fret, we've got your back! You will never have to worry again about consumer experience in your
                  practice.
                </span>
                <Link to="/order" className="primary-btn primary-btn-blue">
                  Get your TV Box Now
                </Link>
              </div>
            </div>
        ...
        <section className="guarantee">
          <div className="wrapper">
            ...
            <p>
              100% Risk-Free, Money-back Guarantee. Our 100% risk-free, satisfaction guarantee, lasts 12 months days
              from the date you receive your device. If for any reason you are not completely satisfied with the
              product, simply send it back to us and we will return you 100% of your money back - no questions asked.
            </p>
